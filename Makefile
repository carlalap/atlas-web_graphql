...
run:
	sudo docker run -d --name $(DOCKER_CONTAINER_NAME) -p 2022:22 -p 8080:8080 -p 9000:9000 -p 9001:9001 -p 4000:4000 -v ${HOST_DIRECTORY}:${CONTAINER_DIRECTORY} ${DOCKER_IMAGE_NAME}
